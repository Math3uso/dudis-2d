...
//     auto baseQuadData = ddgl::createQuadData(SizeF(100, 100), Vec2(50, 50), Rect{0, 0, 32, 32}, 0xFFFFFFFF, tex);
...
//         ddgl::DDTransform2D transform;
//         transform.position = Vec2(400.f, 300.f);
//         transform.origin = Vec2(50.f, 50.f);
//         transform.rotation = 0.f;
//         transform.scale = Vec2(1.f, 1.f);

//         auto quadData = baseQuadData;
//         ddgl::transformDDVertex(transform, quadData, ddgl::DD_REPLACE_POS);
//         render->submit(quadData);
